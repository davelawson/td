...
- Starting a new game opens the static home Plot with `0/0` inhabitants. House construction can add Peasants, Barracks construction can convert those Peasants into Soldiers, Dorm construction can convert one Peasant into one Apprentice, and economic buildings can turn reserved Peasants into post-Raid Wood, Stone, or Metal income. Staff committed to economic buildings or towers cannot currently be released because structure removal and reassignment are not implemented.
