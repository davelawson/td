...
- The current playable shell includes a Sanctum-only starting Plot and a tabbed building bar whose resource, population, and staffing requirements jointly gate Management-phase placement. The same building bar can place Houses, which cost Wood and grant Peasants; Barracks, which cost Wood and Stone and convert Peasants into Soldiers; Dorms, which cost Wood and Stone and convert one Peasant into one Apprentice; and economic buildings, which reserve Peasants and produce resources during Labour. The bar shows values beside icons, shows informational hover tooltips for icon details, uses green outlines for buildable icon squares, and uses red outlines plus 70% icon opacity for capacity-blocked buildings.
