...
- Exploration is implemented only as free adjacent Plot reveal during calm play. Broader scouting, claiming, exploration costs, resource gathering, and broader tower-defense gameplay are intended but not implemented.
