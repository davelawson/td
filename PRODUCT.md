...
- Starting a new game only opens the first placeholder game state; exploration, base-building, real resource changes, and combat are not implemented. The top bar uses fixed prototype values until those systems exist.
