...
4. Extend inhabitants beyond display-only populations. Recruitment, assignment, and population effects should each remain observable slices tied to a concrete player workflow rather than a speculative settlement simulation.
