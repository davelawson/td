...
1. Add the next basic scene interaction. Camera movement, selected-object state, and selected-object detail panels are now the first implemented inspection models; future interaction slices should stay small and avoid placement, upgrades, or resource rules until they have a visible reason to exist.
