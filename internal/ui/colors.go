...
var (
	CharcoalBlack            = color.RGBA{R: 18, G: 19, B: 17, A: 255}
	DarkCharcoalGreen        = color.RGBA{R: 26, G: 32, B: 28, A: 255}
	PineGreen                = color.RGBA{R: 45, G: 58, B: 49, A: 255}
	DarkMossGreen            = color.RGBA{R: 51, G: 57, B: 51, A: 255}
	MossGreen                = color.RGBA{R: 74, G: 83, B: 68, A: 255}
	OliveBrown               = color.RGBA{R: 85, G: 77, B: 54, A: 255}
	Bronze                   = color.RGBA{R: 134, G: 114, B: 65, A: 255}
	LightBronze              = color.RGBA{R: 150, G: 124, B: 49, A: 255}
	...
	SelectionPanelBackground = color.RGBA{R: 26, G: 31, B: 24, A: 232}
