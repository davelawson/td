...
If `PRODUCT.md` exists and the work affects current user-visible capabilities, workflows, scope boundaries, or important product limitations, the ExecPlan must say how `PRODUCT.md` will be updated and validated. If `ROADMAP.md` exists and the work affects product vision, intended audience, strategic priorities, planned capabilities, sequencing assumptions, or explicit non-priorities, the ExecPlan must say how `ROADMAP.md` will be updated and validated. If `GAME.md` exists and the work makes, revises, rejects, or depends on intended gameplay design decisions, the ExecPlan must say how `GAME.md` will be updated and validated. If `CODESTYLE.md` exists and the work affects source conventions, naming rules, TypeScript annotation expectations, documentation conventions, or commenting standards, the ExecPlan must say how `CODESTYLE.md` will be updated and validated. If `DESIGN.md` exists and the work affects stable visual language, interaction principles, or visual-review expectations, the ExecPlan must say how `DESIGN.md` will be updated and validated. If `ART.md` exists and the work affects generated art-asset guidance, prompt patterns, asset review criteria, or prototype asset constraints, the ExecPlan must say how `ART.md` will be updated and validated. If `ARCHITECTURE.md` exists and the work affects durable module boundaries, ownership, extension points, or architectural invariants, the ExecPlan must say how `ARCHITECTURE.md` will be updated and validated. Apply the same rule to any other root-level `ALLCAPS.md` file that defines durable project-wide constraints.
...
Specify repository context explicitly. Name files with full repository-relative paths, name functions and modules precisely, and describe where new files should be created. If touching multiple areas, include a short orientation paragraph that explains how those parts fit together so a novice can navigate confidently. If `PRODUCT.md`, `ROADMAP.md`, `GAME.md`, `DESIGN.md`, `ART.md`, `CODESTYLE.md`, `ARCHITECTURE.md`, or another root-level `ALLCAPS.md` file is relevant, name those files explicitly and summarize the parts of them that constrain the work. When running commands, show the working directory and exact command line. When outcomes depend on environment, state the assumptions and provide alternatives when reasonable.
...
Documentation changes that are part of the feature are also subject to validation. If the ExecPlan includes updates to `PRODUCT.md`, `ROADMAP.md`, `GAME.md`, `DESIGN.md`, `ART.md`, `CODESTYLE.md`, `ARCHITECTURE.md`, or another in-scope root-level `ALLCAPS.md` file, specify what a reviewer should check to confirm those files match the implemented behavior and remain consistent with the intended design, code layout, and user-visible result.
