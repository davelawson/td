...
- Selected raiders and structures should have a plainly brighter visual state that is easy to notice without obscuring the sprite, health bar, road, or Tile context. Selected Tree, Boulder, and Iron Deposit terrain should use a gold Tile outline so the terrain sprite and biome remain readable.
