...
- Static map scenes should keep tile boundaries, roads, and the Sanctum readable before adding decorative terrain or production art. Generated grasslands and hills Tree and Boulder Tiles should read as terrain variation without obscuring road continuity, explored-Plot joins, or buildable empty grass. Hills should read as more Boulder-heavy than grasslands while remaining sparse and mostly buildable. Boulder terrain should use transparent terrain sprites that feel consistent with the pine-tree terrain assets rather than vector placeholder shapes.
